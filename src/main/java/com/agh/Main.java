...
//        List<Vehicle> vehicles = List.of(vehicle1, vehicle2, vehicle3, vehicle4, vehicle5, vehicle6);
        Vehicle vehicle1 = new Vehicle(1, RoadDirection.NORTH, RoadDirection.SOUTH);
        Vehicle vehicle2 = new Vehicle(2, RoadDirection.SOUTH, RoadDirection.EAST);
        Vehicle vehicle3 = new Vehicle(3, RoadDirection.WEST, RoadDirection.EAST);
        Vehicle vehicle4 = new Vehicle(4, RoadDirection.NORTH, RoadDirection.EAST);
